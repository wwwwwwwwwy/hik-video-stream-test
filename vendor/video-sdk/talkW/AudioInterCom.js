var JSAudioInterComModule = (function () {
    ...
    return function (JSAudioInterComModule) {
        ...
        function _alBufferData(bufferId, format, pData, size, freq) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(6, 1, bufferId, format, pData, size, freq);
            if (!AL.currentCtx) {
                return;
            }
            var buf = AL.buffers[bufferId];
        ...
        function _alDeleteBuffers(count, pBufferIds) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(7, 1, count, pBufferIds);
            if (!AL.currentCtx) {
                return;
            }
            for (var i = 0; i < count; ++i) {
        ...
        function _alSourcei(sourceId, param, value) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(8, 1, sourceId, param, value);
            switch (param) {
                case 514:
                case 4097:
                case 4098:
        ...
        function _alDeleteSources(count, pSourceIds) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(9, 1, count, pSourceIds);
            if (!AL.currentCtx) {
                return;
            }
            for (var i = 0; i < count; ++i) {
        ...
        function _alGetEnumValue(pEnumName) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(12, 1, pEnumName);
            if (!AL.currentCtx) {
                return 0;
            }
            if (!pEnumName) {
        ...
        function _alGetSourcef(sourceId, param, pValue) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(14, 1, sourceId, param, pValue);
        ...
        function _alIsSource(sourceId) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(16, 1, sourceId);
            if (!AL.currentCtx) {
                return false;
            }
        ...
        function _alSourceQueueBuffers(sourceId, count, pBufferIds) {
            ...
            for (var i = 0; i < count; ++i) {
                ...
                if (
                    templateBuf.id !== 0 &&
                    (buf.frequency !== templateBuf.frequency || buf.bytesPerSample !== templateBuf.bytesPerSample || buf.channels !== templateBuf.channels)
                ) {
                    AL.currentCtx.err = 40964;
                }
            }
        ...
        function _alcCaptureCloseDevice(deviceId) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(24, 1, deviceId);
        ...
        function _alcCaptureOpenDevice(pDeviceName, requestedSampleRate, format, bufferFrameCapacity) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(25, 1, pDeviceName, requestedSampleRate, format, bufferFrameCapacity);
        ...
        function _alcCaptureSamples(deviceId, pFrames, requestedFrameCount) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(26, 1, deviceId, pFrames, requestedFrameCount);
        ...
        function _alcCloseDevice(deviceId) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(29, 1, deviceId);
        ...
        function _alcCreateContext(deviceId, pAttrList) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(30, 1, deviceId, pAttrList);
        ...
        function _alcGetContextsDevice(contextId) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(32, 1, contextId);
        ...
        function _alcGetEnumValue(deviceId, pEnumName) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(34, 1, deviceId, pEnumName);
        ...
        function _alcGetError(deviceId) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(35, 1, deviceId);
            var err = AL.alcErr;
            AL.alcErr = 0;
            return err;
        }
        function _alcGetIntegerv(deviceId, param, size, pValues) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(36, 1, deviceId, param, size, pValues);
            if (size === 0 || !pValues) {
                return;
            }
            switch (param) {
        ...
        function _alcGetString(deviceId, param) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(37, 1, deviceId, param);
        ...
        function _alcIsExtensionPresent(deviceId, pExtName) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(38, 1, deviceId, pExtName);
        ...
        function _alcOpenDevice(pDeviceName) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(40, 1, pDeviceName);
            if (pDeviceName) {
        ...
        function _emscripten_alcDevicePauseSOFT(deviceId) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(41, 1, deviceId);
            if (!(deviceId in AL.deviceRefCounts)) {
                AL.alcErr = 40961;
                return;
            }
        ...
        function _emscripten_alcGetStringiSOFT(deviceId, param, index) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(43, 1, deviceId, param, index);
            if (!(deviceId in AL.deviceRefCounts)) {
                AL.alcErr = 40961;
                return 0;
            }
        ...
        function _emscripten_alcResetDeviceSOFT(deviceId, pAttrList) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(44, 1, deviceId, pAttrList);
            if (!(deviceId in AL.deviceRefCounts)) {
                AL.alcErr = 40961;
                return 0;
            }
        ...
        var _CaptureDataCallBack = (Module['_CaptureDataCallBack'] = function () {
            return (_CaptureDataCallBack = Module['_CaptureDataCallBack'] = Module['asm']['Ha']).apply(null, arguments);
        });
        var _ResampleDataCallBack = (Module['_ResampleDataCallBack'] = function () {
            return (_ResampleDataCallBack = Module['_ResampleDataCallBack'] = Module['asm']['Ia']).apply(null, arguments);
        });
        var _EncodeDataCallBack = (Module['_EncodeDataCallBack'] = function () {
            return (_EncodeDataCallBack = Module['_EncodeDataCallBack'] = Module['asm']['Ja']).apply(null, arguments);
        });
        var _DecodeDataCallBack = (Module['_DecodeDataCallBack'] = function () {
            return (_DecodeDataCallBack = Module['_DecodeDataCallBack'] = Module['asm']['Ka']).apply(null, arguments);
        });
        var _JSAUDIOCOM_LoadLibrary = (Module['_JSAUDIOCOM_LoadLibrary'] = function () {
            return (_JSAUDIOCOM_LoadLibrary = Module['_JSAUDIOCOM_LoadLibrary'] = Module['asm']['La']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetSoundCardNum = (Module['_JSAUDIOCOM_GetSoundCardNum'] = function () {
            return (_JSAUDIOCOM_GetSoundCardNum = Module['_JSAUDIOCOM_GetSoundCardNum'] = Module['asm']['Ma']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetOneSoundCardInfo = (Module['_JSAUDIOCOM_GetOneSoundCardInfo'] = function () {
            return (_JSAUDIOCOM_GetOneSoundCardInfo = Module['_JSAUDIOCOM_GetOneSoundCardInfo'] = Module['asm']['Na']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetCaptureDeviceNum = (Module['_JSAUDIOCOM_GetCaptureDeviceNum'] = function () {
            return (_JSAUDIOCOM_GetCaptureDeviceNum = Module['_JSAUDIOCOM_GetCaptureDeviceNum'] = Module['asm']['Oa']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetOneCaptureDeviceName = (Module['_JSAUDIOCOM_GetOneCaptureDeviceName'] = function () {
            return (_JSAUDIOCOM_GetOneCaptureDeviceName = Module['_JSAUDIOCOM_GetOneCaptureDeviceName'] = Module['asm']['Pa']).apply(null, arguments);
        });
        var _JSAUDIOCOM_CreateCaptureHandle = (Module['_JSAUDIOCOM_CreateCaptureHandle'] = function () {
            return (_JSAUDIOCOM_CreateCaptureHandle = Module['_JSAUDIOCOM_CreateCaptureHandle'] = Module['asm']['Qa']).apply(null, arguments);
        });
        var _JSAUDIOCOM_RegisterCaptureDataCallBack = (Module['_JSAUDIOCOM_RegisterCaptureDataCallBack'] = function () {
            return (_JSAUDIOCOM_RegisterCaptureDataCallBack = Module['_JSAUDIOCOM_RegisterCaptureDataCallBack'] = Module['asm']['Ra']).apply(null, arguments);
        });
        var _JSAUDIOCOM_RegisterEncodeDataCallBack0 = (Module['_JSAUDIOCOM_RegisterEncodeDataCallBack0'] = function () {
            return (_JSAUDIOCOM_RegisterEncodeDataCallBack0 = Module['_JSAUDIOCOM_RegisterEncodeDataCallBack0'] = Module['asm']['Sa']).apply(null, arguments);
        });
        var _JSAUDIOCOM_RegisterResampleDataCallBack = (Module['_JSAUDIOCOM_RegisterResampleDataCallBack'] = function () {
            return (_JSAUDIOCOM_RegisterResampleDataCallBack = Module['_JSAUDIOCOM_RegisterResampleDataCallBack'] = Module['asm']['Ta']).apply(null, arguments);
        });
        var _JSAUDIOCOM_StartCapture = (Module['_JSAUDIOCOM_StartCapture'] = function () {
            return (_JSAUDIOCOM_StartCapture = Module['_JSAUDIOCOM_StartCapture'] = Module['asm']['Ua']).apply(null, arguments);
        });
        var _JSAUDIOCOM_StopCapture = (Module['_JSAUDIOCOM_StopCapture'] = function () {
            return (_JSAUDIOCOM_StopCapture = Module['_JSAUDIOCOM_StopCapture'] = Module['asm']['Va']).apply(null, arguments);
        });
        var _JSAUDIOCOM_ReleaseCaptureHandle = (Module['_JSAUDIOCOM_ReleaseCaptureHandle'] = function () {
            return (_JSAUDIOCOM_ReleaseCaptureHandle = Module['_JSAUDIOCOM_ReleaseCaptureHandle'] = Module['asm']['Wa']).apply(null, arguments);
        });
        var _JSAUDIOCOM_SetCaptureStatus = (Module['_JSAUDIOCOM_SetCaptureStatus'] = function () {
            return (_JSAUDIOCOM_SetCaptureStatus = Module['_JSAUDIOCOM_SetCaptureStatus'] = Module['asm']['Xa']).apply(null, arguments);
        });
        var _JSAUDIOCOM_CreateEncodeHandle = (Module['_JSAUDIOCOM_CreateEncodeHandle'] = function () {
            return (_JSAUDIOCOM_CreateEncodeHandle = Module['_JSAUDIOCOM_CreateEncodeHandle'] = Module['asm']['Ya']).apply(null, arguments);
        });
        var _JSAUDIOCOM_RegisterEncodeDataCallBack = (Module['_JSAUDIOCOM_RegisterEncodeDataCallBack'] = function () {
            return (_JSAUDIOCOM_RegisterEncodeDataCallBack = Module['_JSAUDIOCOM_RegisterEncodeDataCallBack'] = Module['asm']['Za']).apply(null, arguments);
        });
        var _JSAUDIOCOM_StartEncode = (Module['_JSAUDIOCOM_StartEncode'] = function () {
            return (_JSAUDIOCOM_StartEncode = Module['_JSAUDIOCOM_StartEncode'] = Module['asm']['_a']).apply(null, arguments);
        });
        var _JSAUDIOCOM_InputEncodeData = (Module['_JSAUDIOCOM_InputEncodeData'] = function () {
            return (_JSAUDIOCOM_InputEncodeData = Module['_JSAUDIOCOM_InputEncodeData'] = Module['asm']['$a']).apply(null, arguments);
        });
        var _JSAUDIOCOM_StopEncode = (Module['_JSAUDIOCOM_StopEncode'] = function () {
            return (_JSAUDIOCOM_StopEncode = Module['_JSAUDIOCOM_StopEncode'] = Module['asm']['ab']).apply(null, arguments);
        });
        var _JSAUDIOCOM_ReleaseEncodeHandle = (Module['_JSAUDIOCOM_ReleaseEncodeHandle'] = function () {
            return (_JSAUDIOCOM_ReleaseEncodeHandle = Module['_JSAUDIOCOM_ReleaseEncodeHandle'] = Module['asm']['bb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetPlayDeviceNum = (Module['_JSAUDIOCOM_GetPlayDeviceNum'] = function () {
            return (_JSAUDIOCOM_GetPlayDeviceNum = Module['_JSAUDIOCOM_GetPlayDeviceNum'] = Module['asm']['cb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetOnePlayDeviceName = (Module['_JSAUDIOCOM_GetOnePlayDeviceName'] = function () {
            return (_JSAUDIOCOM_GetOnePlayDeviceName = Module['_JSAUDIOCOM_GetOnePlayDeviceName'] = Module['asm']['db']).apply(null, arguments);
        });
        var _JSAUDIOCOM_CreatePlayHandle = (Module['_JSAUDIOCOM_CreatePlayHandle'] = function () {
            return (_JSAUDIOCOM_CreatePlayHandle = Module['_JSAUDIOCOM_CreatePlayHandle'] = Module['asm']['eb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_OpenStream = (Module['_JSAUDIOCOM_OpenStream'] = function () {
            return (_JSAUDIOCOM_OpenStream = Module['_JSAUDIOCOM_OpenStream'] = Module['asm']['fb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_RegisterDecodeDataCallBack = (Module['_JSAUDIOCOM_RegisterDecodeDataCallBack'] = function () {
            return (_JSAUDIOCOM_RegisterDecodeDataCallBack = Module['_JSAUDIOCOM_RegisterDecodeDataCallBack'] = Module['asm']['gb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_StartPlay = (Module['_JSAUDIOCOM_StartPlay'] = function () {
            return (_JSAUDIOCOM_StartPlay = Module['_JSAUDIOCOM_StartPlay'] = Module['asm']['hb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_SetPlayStatus = (Module['_JSAUDIOCOM_SetPlayStatus'] = function () {
            return (_JSAUDIOCOM_SetPlayStatus = Module['_JSAUDIOCOM_SetPlayStatus'] = Module['asm']['ib']).apply(null, arguments);
        });
        var _JSAUDIOCOM_InputStreamData = (Module['_JSAUDIOCOM_InputStreamData'] = function () {
            return (_JSAUDIOCOM_InputStreamData = Module['_JSAUDIOCOM_InputStreamData'] = Module['asm']['jb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_StopPlay = (Module['_JSAUDIOCOM_StopPlay'] = function () {
            return (_JSAUDIOCOM_StopPlay = Module['_JSAUDIOCOM_StopPlay'] = Module['asm']['kb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_ReleasePlayHandle = (Module['_JSAUDIOCOM_ReleasePlayHandle'] = function () {
            return (_JSAUDIOCOM_ReleasePlayHandle = Module['_JSAUDIOCOM_ReleasePlayHandle'] = Module['asm']['lb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_SetVolume = (Module['_JSAUDIOCOM_SetVolume'] = function () {
            return (_JSAUDIOCOM_SetVolume = Module['_JSAUDIOCOM_SetVolume'] = Module['asm']['mb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetVolume = (Module['_JSAUDIOCOM_GetVolume'] = function () {
            return (_JSAUDIOCOM_GetVolume = Module['_JSAUDIOCOM_GetVolume'] = Module['asm']['nb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetLastError = (Module['_JSAUDIOCOM_GetLastError'] = function () {
            return (_JSAUDIOCOM_GetLastError = Module['_JSAUDIOCOM_GetLastError'] = Module['asm']['ob']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetSDKVersion = (Module['_JSAUDIOCOM_GetSDKVersion'] = function () {
            return (_JSAUDIOCOM_GetSDKVersion = Module['_JSAUDIOCOM_GetSDKVersion'] = Module['asm']['pb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetBuildDate = (Module['_JSAUDIOCOM_GetBuildDate'] = function () {
            return (_JSAUDIOCOM_GetBuildDate = Module['_JSAUDIOCOM_GetBuildDate'] = Module['asm']['qb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetPlayBufferRemian = (Module['_JSAUDIOCOM_GetPlayBufferRemian'] = function () {
            return (_JSAUDIOCOM_GetPlayBufferRemian = Module['_JSAUDIOCOM_GetPlayBufferRemian'] = Module['asm']['rb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_GetBufferValue = (Module['_JSAUDIOCOM_GetBufferValue'] = function () {
            return (_JSAUDIOCOM_GetBufferValue = Module['_JSAUDIOCOM_GetBufferValue'] = Module['asm']['sb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_SetPrintLogFlag = (Module['_JSAUDIOCOM_SetPrintLogFlag'] = function () {
            return (_JSAUDIOCOM_SetPrintLogFlag = Module['_JSAUDIOCOM_SetPrintLogFlag'] = Module['asm']['tb']).apply(null, arguments);
        });
        var _JSAUDIOCOM_SetResampleParam = (Module['_JSAUDIOCOM_SetResampleParam'] = function () {
            return (_JSAUDIOCOM_SetResampleParam = Module['_JSAUDIOCOM_SetResampleParam'] = Module['asm']['ub']).apply(null, arguments);
        });
        var _JSAUDIOCOM_SetANRParam = (Module['_JSAUDIOCOM_SetANRParam'] = function () {
            return (_JSAUDIOCOM_SetANRParam = Module['_JSAUDIOCOM_SetANRParam'] = Module['asm']['vb']).apply(null, arguments);
        });
        var _emscripten_tls_init = (Module['_emscripten_tls_init'] = function () {
            return (_emscripten_tls_init = Module['_emscripten_tls_init'] = Module['asm']['wb']).apply(null, arguments);
        });
        var ___getTypeName = (Module['___getTypeName'] = function () {
            return (___getTypeName = Module['___getTypeName'] = Module['asm']['yb']).apply(null, arguments);
        });
        var ___embind_register_native_and_builtin_types = (Module['___embind_register_native_and_builtin_types'] = function () {
            return (___embind_register_native_and_builtin_types = Module['___embind_register_native_and_builtin_types'] = Module['asm']['zb']).apply(null, arguments);
        });
        ...
        var _emscripten_sync_run_in_main_thread_4 = (Module['_emscripten_sync_run_in_main_thread_4'] = function () {
            return (_emscripten_sync_run_in_main_thread_4 = Module['_emscripten_sync_run_in_main_thread_4'] = Module['asm']['Cb']).apply(null, arguments);
        });
        var _emscripten_main_thread_process_queued_calls = (Module['_emscripten_main_thread_process_queued_calls'] = function () {
            return (_emscripten_main_thread_process_queued_calls = Module['_emscripten_main_thread_process_queued_calls'] = Module['asm']['Db']).apply(null, arguments);
        });
        var _emscripten_run_in_main_runtime_thread_js = (Module['_emscripten_run_in_main_runtime_thread_js'] = function () {
            return (_emscripten_run_in_main_runtime_thread_js = Module['_emscripten_run_in_main_runtime_thread_js'] = Module['asm']['Eb']).apply(null, arguments);
        });
        var __emscripten_call_on_thread = (Module['__emscripten_call_on_thread'] = function () {
            return (__emscripten_call_on_thread = Module['__emscripten_call_on_thread'] = Module['asm']['Fb']).apply(null, arguments);
        });
        var __emscripten_thread_exit = (Module['__emscripten_thread_exit'] = function () {
            return (__emscripten_thread_exit = Module['__emscripten_thread_exit'] = Module['asm']['Gb']).apply(null, arguments);
        });
        var _pthread_testcancel = (Module['_pthread_testcancel'] = function () {
            return (_pthread_testcancel = Module['_pthread_testcancel'] = Module['asm']['Hb']).apply(null, arguments);
        });
        ...
        var _emscripten_stack_set_limits = (Module['_emscripten_stack_set_limits'] = function () {
            return (_emscripten_stack_set_limits = Module['_emscripten_stack_set_limits'] = Module['asm']['Ob']).apply(null, arguments);
        });
        var _free = (Module['_free'] = function () {
            return (_free = Module['_free'] = Module['asm']['Pb']).apply(null, arguments);
        });
        var _memalign = (Module['_memalign'] = function () {
            return (_memalign = Module['_memalign'] = Module['asm']['Qb']).apply(null, arguments);
        });
        var dynCall_jiji = (Module['dynCall_jiji'] = function () {
            return (dynCall_jiji = Module['dynCall_jiji'] = Module['asm']['Rb']).apply(null, arguments);
        });
        var __emscripten_allow_main_runtime_queued_calls = (Module['__emscripten_allow_main_runtime_queued_calls'] = 299888);
        var __emscripten_main_thread_futex = (Module['__emscripten_main_thread_futex'] = 373312);
        Module['ccall'] = ccall;
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = JSAudioInterComModule;
else if (typeof define === 'function' && define['amd'])
    define([], function () {
        return JSAudioInterComModule;
    });
else if (typeof exports === 'object') exports['JSAudioInterComModule'] = JSAudioInterComModule;
