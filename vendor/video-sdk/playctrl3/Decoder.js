    ...
    return function (JSPlayerModule) {
        ...
        function createWasm() {
            ...
            function receiveInstance(instance, module) {
                ...
                addOnInit(Module['asm']['Gb']);
                PThread.tlsInitFunctions.push(Module['asm']['vd']);
                wasmModule = module;
                if (!ENVIRONMENT_IS_PTHREAD) {
        ...
        var PThread = {
            ...
            threadInit: function () {
                for (var i = 0; i < PThread.tlsInitFunctions.length; i++) {
        ...
        function _AdditionDataCB(port, pstAddDataInfo, nUser) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(1, 0, port, pstAddDataInfo, nUser);
            JSPlayM4_AdditionDataCBFun(port, pstAddDataInfo, nUser);
        }
        function _DecCB(port, pYUVPCMData, size, type, timestamp, nUser) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(2, 0, port, pYUVPCMData, size, type, timestamp, nUser);
        ...
        function _FirstFrameCB(port, nUser) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(3, 0, port, nUser);
            JSPlayM4_FirstFrameCallBack(port, nUser);
        }
        function _RawDataCB(port, pRawData, size, rawVideoInfo, nUser) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(4, 0, port, pRawData, size, rawVideoInfo, nUser);
        ...
        function _RunTimeInfoCB(port, pstRunTimeInfo, nUser) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(5, 0, port, pstRunTimeInfo, nUser);
            JSPlayM4_RunTimeInfoCallBack(port, pstRunTimeInfo, nUser);
        }
        function _YUVDisplayCB(port, yuvData, size, timestamp, nUser) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(6, 0, port, yuvData, size, timestamp, nUser);
        ...
        function _atexit(func, arg) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(7, 1, func, arg);
        }
        ...
        function _alBufferData(bufferId, format, pData, size, freq) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(12, 1, bufferId, format, pData, size, freq);
            if (!AL.currentCtx) {
                return;
            }
            var buf = AL.buffers[bufferId];
        ...
        function _alSourcei(sourceId, param, value) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(14, 1, sourceId, param, value);
            switch (param) {
                case 514:
                case 4097:
                case 4098:
        ...
        function _alDeleteSources(count, pSourceIds) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(15, 1, count, pSourceIds);
            if (!AL.currentCtx) {
                return;
            }
            for (var i = 0; i < count; ++i) {
        ...
        function _alGenBuffers(count, pBufferIds) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(16, 1, count, pBufferIds);
            if (!AL.currentCtx) {
                return;
            }
            for (var i = 0; i < count; ++i) {
        ...
        function _alGenSources(count, pSourceIds) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(17, 1, count, pSourceIds);
            if (!AL.currentCtx) {
                return;
            }
            for (var i = 0; i < count; ++i) {
        ...
        function _alGetSourcef(sourceId, param, pValue) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(19, 1, sourceId, param, pValue);
        ...
        function _alGetSourcei(sourceId, param, pValue) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(20, 1, sourceId, param, pValue);
        ...
        function _alListenerfv(param, pValues) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(21, 1, param, pValues);
            if (!AL.currentCtx) {
                return;
            }
            if (!pValues) {
        ...
        function _alSourcePlay(sourceId) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(22, 1, sourceId);
            if (!AL.currentCtx) {
                return;
            }
            var src = AL.currentCtx.sources[sourceId];
        ...
        function _alSourceQueueBuffers(sourceId, count, pBufferIds) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(23, 1, sourceId, count, pBufferIds);
            if (!AL.currentCtx) {
                return;
            }
            var src = AL.currentCtx.sources[sourceId];
        ...
        function _alSourceStop(sourceId) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(24, 1, sourceId);
            if (!AL.currentCtx) {
                return;
            }
            var src = AL.currentCtx.sources[sourceId];
        ...
        function _alSourceUnqueueBuffers(sourceId, count, pBufferIds) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(25, 1, sourceId, count, pBufferIds);
            if (!AL.currentCtx) {
                return;
            }
            var src = AL.currentCtx.sources[sourceId];
        ...
        function _alSourcefv(sourceId, param, pValues) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(27, 1, sourceId, param, pValues);
            if (!AL.currentCtx) {
                return;
            }
            if (!pValues) {
        ...
        function _alcCreateContext(deviceId, pAttrList) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(28, 1, deviceId, pAttrList);
        ...
        function _alcGetString(deviceId, param) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(30, 1, deviceId, param);
        ...
        function _emscripten_webgl_destroy_context_main_thread(a0) {
            if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(35, 1, a0);
        ...
        var asmLibraryArg = {
            ...
            Fb: ___cxa_thread_atexit,
            c: ___cxa_throw,
            db: ___emscripten_init_main_thread_js,
            Qa: ___localtime_r,
            ha: ___pthread_create_js,
            cb: ___pthread_detached_exit,
            ob: ___pthread_exit_run_handlers,
            Ua: ___pthread_join_js,
            _: ___sys_fcntl64,
            Sa: ___sys_ioctl,
            Ta: ___sys_open,
            ...
            hb: __emscripten_notify_thread_queue,
            ...
            K: _alSourceStop,
            B: _alSourceUnqueueBuffers,
            J: _alSourcef,
            ga: _alSourcefv,
            sb: _alSourcei,
            wb: _alcCreateContext,
            ia: _alcGetCurrentContext,
            qb: _alcGetString,
            vb: _alcMakeContextCurrent,
            pb: _alcOpenDevice,
            s: _clock_gettime,
            z: _emscripten_asm_const_int,
            H: _emscripten_cancel_main_loop,
            Pa: _emscripten_check_blocking_allowed,
            A: _emscripten_conditional_set_current_thread_status,
            q: _emscripten_futex_wait,
            l: _emscripten_futex_wake,
            La: _emscripten_get_canvas_element_size,
            m: _emscripten_get_now,
            _a: _emscripten_memcpy_big,
            fb: _emscripten_receive_on_main_thread_js,
            $a: _emscripten_resize_heap,
            ba: _emscripten_set_canvas_element_size,
            ca: _emscripten_set_current_thread_status,
            da: _emscripten_set_main_loop_arg,
            eb: _emscripten_set_timeout,
            lb: _emscripten_supports_offscreencanvas,
            ab: _emscripten_unwind_to_js_event_loop,
            Ma: _emscripten_webgl_commit_frame,
            G: _emscripten_webgl_create_context,
            X: _emscripten_webgl_destroy_context,
            W: _emscripten_webgl_get_current_context,
        ...
        var ___wasm_call_ctors = (Module['___wasm_call_ctors'] = function () {
            return (___wasm_call_ctors = Module['___wasm_call_ctors'] = Module['asm']['Gb']).apply(null, arguments);
        });
        var _DecCallBack = (Module['_DecCallBack'] = function () {
            return (_DecCallBack = Module['_DecCallBack'] = Module['asm']['Hb']).apply(null, arguments);
        });
        ...
        var _RawDataCallBack = (Module['_RawDataCallBack'] = function () {
            return (_RawDataCallBack = Module['_RawDataCallBack'] = Module['asm']['Jb']).apply(null, arguments);
        });
        ...
        var _getTotalMemory = (Module['_getTotalMemory'] = function () {
            return (_getTotalMemory = Module['_getTotalMemory'] = Module['asm']['Lb']).apply(null, arguments);
        });
        var _getFreeMemory = (Module['_getFreeMemory'] = function () {
            return (_getFreeMemory = Module['_getFreeMemory'] = Module['asm']['Mb']).apply(null, arguments);
        });
        var _AdditionDataCBFun = (Module['_AdditionDataCBFun'] = function () {
            return (_AdditionDataCBFun = Module['_AdditionDataCBFun'] = Module['asm']['Nb']).apply(null, arguments);
        });
        var _RunTimeInfoCBFun = (Module['_RunTimeInfoCBFun'] = function () {
            return (_RunTimeInfoCBFun = Module['_RunTimeInfoCBFun'] = Module['asm']['Ob']).apply(null, arguments);
        });
        var _JSPlayM4_GetFrameInfo = (Module['_JSPlayM4_GetFrameInfo'] = function () {
            return (_JSPlayM4_GetFrameInfo = Module['_JSPlayM4_GetFrameInfo'] = Module['asm']['Pb']).apply(null, arguments);
        });
        var _JSPlayM4_GetPort = (Module['_JSPlayM4_GetPort'] = function () {
            return (_JSPlayM4_GetPort = Module['_JSPlayM4_GetPort'] = Module['asm']['Qb']).apply(null, arguments);
        });
        var _JSPlayM4_SetStreamOpenMode = (Module['_JSPlayM4_SetStreamOpenMode'] = function () {
            return (_JSPlayM4_SetStreamOpenMode = Module['_JSPlayM4_SetStreamOpenMode'] = Module['asm']['Rb']).apply(null, arguments);
        });
        var _JSPlayM4_OpenStream = (Module['_JSPlayM4_OpenStream'] = function () {
            return (_JSPlayM4_OpenStream = Module['_JSPlayM4_OpenStream'] = Module['asm']['Sb']).apply(null, arguments);
        });
        var _JSPlayM4_SetFirstFrameCallBack = (Module['_JSPlayM4_SetFirstFrameCallBack'] = function () {
            return (_JSPlayM4_SetFirstFrameCallBack = Module['_JSPlayM4_SetFirstFrameCallBack'] = Module['asm']['Tb']).apply(null, arguments);
        });
        var _JSPlayM4_SetDecCallBack = (Module['_JSPlayM4_SetDecCallBack'] = function () {
            return (_JSPlayM4_SetDecCallBack = Module['_JSPlayM4_SetDecCallBack'] = Module['asm']['Ub']).apply(null, arguments);
        });
        var _JSPlayM4_SetDisplayCallBack = (Module['_JSPlayM4_SetDisplayCallBack'] = function () {
            return (_JSPlayM4_SetDisplayCallBack = Module['_JSPlayM4_SetDisplayCallBack'] = Module['asm']['Vb']).apply(null, arguments);
        });
        var _JSPlayM4_SetFrameInfoCallBack = (Module['_JSPlayM4_SetFrameInfoCallBack'] = function () {
            return (_JSPlayM4_SetFrameInfoCallBack = Module['_JSPlayM4_SetFrameInfoCallBack'] = Module['asm']['Wb']).apply(null, arguments);
        });
        var _JSPlayM4_SetResetCallBack = (Module['_JSPlayM4_SetResetCallBack'] = function () {
            return (_JSPlayM4_SetResetCallBack = Module['_JSPlayM4_SetResetCallBack'] = Module['asm']['Xb']).apply(null, arguments);
        });
        var _JSPlayM4_SetVideoRawDataCallBack0 = (Module['_JSPlayM4_SetVideoRawDataCallBack0'] = function () {
            return (_JSPlayM4_SetVideoRawDataCallBack0 = Module['_JSPlayM4_SetVideoRawDataCallBack0'] = Module['asm']['Yb']).apply(null, arguments);
        });
        var _JSPlayM4_SetVideoRawDataCallBack = (Module['_JSPlayM4_SetVideoRawDataCallBack'] = function () {
            return (_JSPlayM4_SetVideoRawDataCallBack = Module['_JSPlayM4_SetVideoRawDataCallBack'] = Module['asm']['Zb']).apply(null, arguments);
        });
        var _JSPlayM4_SetDecCBStream = (Module['_JSPlayM4_SetDecCBStream'] = function () {
            return (_JSPlayM4_SetDecCBStream = Module['_JSPlayM4_SetDecCBStream'] = Module['asm']['_b']).apply(null, arguments);
        });
        var _JSPlayM4_Play = (Module['_JSPlayM4_Play'] = function () {
            return (_JSPlayM4_Play = Module['_JSPlayM4_Play'] = Module['asm']['$b']).apply(null, arguments);
        });
        var _JSPlayM4_InputData = (Module['_JSPlayM4_InputData'] = function () {
            return (_JSPlayM4_InputData = Module['_JSPlayM4_InputData'] = Module['asm']['ac']).apply(null, arguments);
        });
        var _JSPlayM4_Stop = (Module['_JSPlayM4_Stop'] = function () {
            return (_JSPlayM4_Stop = Module['_JSPlayM4_Stop'] = Module['asm']['bc']).apply(null, arguments);
        });
        var _JSPlayM4_CloseStream = (Module['_JSPlayM4_CloseStream'] = function () {
            return (_JSPlayM4_CloseStream = Module['_JSPlayM4_CloseStream'] = Module['asm']['cc']).apply(null, arguments);
        });
        var _JSPlayM4_FreePort = (Module['_JSPlayM4_FreePort'] = function () {
            return (_JSPlayM4_FreePort = Module['_JSPlayM4_FreePort'] = Module['asm']['dc']).apply(null, arguments);
        });
        var _JSPlayM4_SetDecodeFrameType = (Module['_JSPlayM4_SetDecodeFrameType'] = function () {
            return (_JSPlayM4_SetDecodeFrameType = Module['_JSPlayM4_SetDecodeFrameType'] = Module['asm']['ec']).apply(null, arguments);
        });
        var _JSPlayM4_PlaySound = (Module['_JSPlayM4_PlaySound'] = function () {
            return (_JSPlayM4_PlaySound = Module['_JSPlayM4_PlaySound'] = Module['asm']['fc']).apply(null, arguments);
        });
        var _JSPlayM4_SetSecretKey = (Module['_JSPlayM4_SetSecretKey'] = function () {
            return (_JSPlayM4_SetSecretKey = Module['_JSPlayM4_SetSecretKey'] = Module['asm']['gc']).apply(null, arguments);
        });
        var _JSPlayM4_GetJPEG = (Module['_JSPlayM4_GetJPEG'] = function () {
            return (_JSPlayM4_GetJPEG = Module['_JSPlayM4_GetJPEG'] = Module['asm']['hc']).apply(null, arguments);
        });
        var _JSPlayM4_GetBMP = (Module['_JSPlayM4_GetBMP'] = function () {
            return (_JSPlayM4_GetBMP = Module['_JSPlayM4_GetBMP'] = Module['asm']['ic']).apply(null, arguments);
        });
        var _JSPlayM4_GetCropJPEG = (Module['_JSPlayM4_GetCropJPEG'] = function () {
            return (_JSPlayM4_GetCropJPEG = Module['_JSPlayM4_GetCropJPEG'] = Module['asm']['jc']).apply(null, arguments);
        });
        var _JSPlayM4_GetCropBMP = (Module['_JSPlayM4_GetCropBMP'] = function () {
            return (_JSPlayM4_GetCropBMP = Module['_JSPlayM4_GetCropBMP'] = Module['asm']['kc']).apply(null, arguments);
        });
        var _JSPlayM4_StopSound = (Module['_JSPlayM4_StopSound'] = function () {
            return (_JSPlayM4_StopSound = Module['_JSPlayM4_StopSound'] = Module['asm']['lc']).apply(null, arguments);
        });
        var _JSPlayM4_GetSDKVersion = (Module['_JSPlayM4_GetSDKVersion'] = function () {
            return (_JSPlayM4_GetSDKVersion = Module['_JSPlayM4_GetSDKVersion'] = Module['asm']['mc']).apply(null, arguments);
        });
        var _JSPlayM4_GetBuildDate = (Module['_JSPlayM4_GetBuildDate'] = function () {
            return (_JSPlayM4_GetBuildDate = Module['_JSPlayM4_GetBuildDate'] = Module['asm']['nc']).apply(null, arguments);
        });
        var _JSPlayM4_GetLastError = (Module['_JSPlayM4_GetLastError'] = function () {
            return (_JSPlayM4_GetLastError = Module['_JSPlayM4_GetLastError'] = Module['asm']['oc']).apply(null, arguments);
        });
        var _JSPlayM4_Fast = (Module['_JSPlayM4_Fast'] = function () {
            return (_JSPlayM4_Fast = Module['_JSPlayM4_Fast'] = Module['asm']['pc']).apply(null, arguments);
        });
        var _JSPlayM4_Slow = (Module['_JSPlayM4_Slow'] = function () {
            return (_JSPlayM4_Slow = Module['_JSPlayM4_Slow'] = Module['asm']['qc']).apply(null, arguments);
        });
        var _JSPlayM4_SetIFrameDecInterval = (Module['_JSPlayM4_SetIFrameDecInterval'] = function () {
            return (_JSPlayM4_SetIFrameDecInterval = Module['_JSPlayM4_SetIFrameDecInterval'] = Module['asm']['rc']).apply(null, arguments);
        });
        var _JSPlayM4_SetDecodeThread = (Module['_JSPlayM4_SetDecodeThread'] = function () {
            return (_JSPlayM4_SetDecodeThread = Module['_JSPlayM4_SetDecodeThread'] = Module['asm']['sc']).apply(null, arguments);
        });
        var _JSPlayM4_Pause = (Module['_JSPlayM4_Pause'] = function () {
            return (_JSPlayM4_Pause = Module['_JSPlayM4_Pause'] = Module['asm']['tc']).apply(null, arguments);
        });
        var _JSPlayM4_OneByOne = (Module['_JSPlayM4_OneByOne'] = function () {
            return (_JSPlayM4_OneByOne = Module['_JSPlayM4_OneByOne'] = Module['asm']['uc']).apply(null, arguments);
        });
        var _JSPlayM4_SetVolume = (Module['_JSPlayM4_SetVolume'] = function () {
            return (_JSPlayM4_SetVolume = Module['_JSPlayM4_SetVolume'] = Module['asm']['vc']).apply(null, arguments);
        });
        var _JSPlayM4_GetVolume = (Module['_JSPlayM4_GetVolume'] = function () {
            return (_JSPlayM4_GetVolume = Module['_JSPlayM4_GetVolume'] = Module['asm']['wc']).apply(null, arguments);
        });
        var _JSPlayM4_SetDisplayRegion = (Module['_JSPlayM4_SetDisplayRegion'] = function () {
            return (_JSPlayM4_SetDisplayRegion = Module['_JSPlayM4_SetDisplayRegion'] = Module['asm']['xc']).apply(null, arguments);
        });
        var _JSPlayM4_SetPrintLogFlag = (Module['_JSPlayM4_SetPrintLogFlag'] = function () {
            return (_JSPlayM4_SetPrintLogFlag = Module['_JSPlayM4_SetPrintLogFlag'] = Module['asm']['yc']).apply(null, arguments);
        });
        var _JSPlayM4_RenderPrivateData = (Module['_JSPlayM4_RenderPrivateData'] = function () {
            return (_JSPlayM4_RenderPrivateData = Module['_JSPlayM4_RenderPrivateData'] = Module['asm']['zc']).apply(null, arguments);
        });
        var _JSPlayM4_RenderPrivateDataEx = (Module['_JSPlayM4_RenderPrivateDataEx'] = function () {
            return (_JSPlayM4_RenderPrivateDataEx = Module['_JSPlayM4_RenderPrivateDataEx'] = Module['asm']['Ac']).apply(null, arguments);
        });
        var _JSPlayM4_SetCanvasSize = (Module['_JSPlayM4_SetCanvasSize'] = function () {
            return (_JSPlayM4_SetCanvasSize = Module['_JSPlayM4_SetCanvasSize'] = Module['asm']['Bc']).apply(null, arguments);
        });
        var _JSPlayM4_SetDisplayBuf = (Module['_JSPlayM4_SetDisplayBuf'] = function () {
            return (_JSPlayM4_SetDisplayBuf = Module['_JSPlayM4_SetDisplayBuf'] = Module['asm']['Cc']).apply(null, arguments);
        });
        var _JSPlayM4_SetAudioDisplayBuf = (Module['_JSPlayM4_SetAudioDisplayBuf'] = function () {
            return (_JSPlayM4_SetAudioDisplayBuf = Module['_JSPlayM4_SetAudioDisplayBuf'] = Module['asm']['Dc']).apply(null, arguments);
        });
        var _JSPlayM4_GetSourceBufferRemain = (Module['_JSPlayM4_GetSourceBufferRemain'] = function () {
            return (_JSPlayM4_GetSourceBufferRemain = Module['_JSPlayM4_GetSourceBufferRemain'] = Module['asm']['Ec']).apply(null, arguments);
        });
        var _JSPlayM4_GetBufferValue = (Module['_JSPlayM4_GetBufferValue'] = function () {
            return (_JSPlayM4_GetBufferValue = Module['_JSPlayM4_GetBufferValue'] = Module['asm']['Fc']).apply(null, arguments);
        });
        var _JSPlayM4_ReversePlay = (Module['_JSPlayM4_ReversePlay'] = function () {
            return (_JSPlayM4_ReversePlay = Module['_JSPlayM4_ReversePlay'] = Module['asm']['Gc']).apply(null, arguments);
        });
        var _JSPlayM4_SetDecodeThreadNum = (Module['_JSPlayM4_SetDecodeThreadNum'] = function () {
            return (_JSPlayM4_SetDecodeThreadNum = Module['_JSPlayM4_SetDecodeThreadNum'] = Module['asm']['Hc']).apply(null, arguments);
        });
        var _JSPlayM4_GetCanvasSize = (Module['_JSPlayM4_GetCanvasSize'] = function () {
            return (_JSPlayM4_GetCanvasSize = Module['_JSPlayM4_GetCanvasSize'] = Module['asm']['Ic']).apply(null, arguments);
        });
        var _JSPlayM4_DisplayLostFrames = (Module['_JSPlayM4_DisplayLostFrames'] = function () {
            return (_JSPlayM4_DisplayLostFrames = Module['_JSPlayM4_DisplayLostFrames'] = Module['asm']['Jc']).apply(null, arguments);
        });
        var _JSPlayM4_SetANRParam = (Module['_JSPlayM4_SetANRParam'] = function () {
            return (_JSPlayM4_SetANRParam = Module['_JSPlayM4_SetANRParam'] = Module['asm']['Kc']).apply(null, arguments);
        });
        var _JSPlayM4_SetResampleValue = (Module['_JSPlayM4_SetResampleValue'] = function () {
            return (_JSPlayM4_SetResampleValue = Module['_JSPlayM4_SetResampleValue'] = Module['asm']['Lc']).apply(null, arguments);
        });
        var _JSPlayM4_SetAntialias = (Module['_JSPlayM4_SetAntialias'] = function () {
            return (_JSPlayM4_SetAntialias = Module['_JSPlayM4_SetAntialias'] = Module['asm']['Mc']).apply(null, arguments);
        });
        var _JSPlayM4_SyncToAudio = (Module['_JSPlayM4_SyncToAudio'] = function () {
            return (_JSPlayM4_SyncToAudio = Module['_JSPlayM4_SyncToAudio'] = Module['asm']['Nc']).apply(null, arguments);
        });
        var _JSPlayM4_SetAudioThreadModel = (Module['_JSPlayM4_SetAudioThreadModel'] = function () {
            return (_JSPlayM4_SetAudioThreadModel = Module['_JSPlayM4_SetAudioThreadModel'] = Module['asm']['Oc']).apply(null, arguments);
        });
        var _JSPlayM4_SetDecodeERC = (Module['_JSPlayM4_SetDecodeERC'] = function () {
            return (_JSPlayM4_SetDecodeERC = Module['_JSPlayM4_SetDecodeERC'] = Module['asm']['Pc']).apply(null, arguments);
        });
        var _JSPlayM4_SkipErrorData = (Module['_JSPlayM4_SkipErrorData'] = function () {
            return (_JSPlayM4_SkipErrorData = Module['_JSPlayM4_SkipErrorData'] = Module['asm']['Qc']).apply(null, arguments);
        });
        var _JSPlayM4_SetAdditionDataCallBack = (Module['_JSPlayM4_SetAdditionDataCallBack'] = function () {
            return (_JSPlayM4_SetAdditionDataCallBack = Module['_JSPlayM4_SetAdditionDataCallBack'] = Module['asm']['Rc']).apply(null, arguments);
        });
        var _JSPlayM4_GetAdditionData = (Module['_JSPlayM4_GetAdditionData'] = function () {
            return (_JSPlayM4_GetAdditionData = Module['_JSPlayM4_GetAdditionData'] = Module['asm']['Sc']).apply(null, arguments);
        });
        var _JSPlayM4_SetDemuxModel = (Module['_JSPlayM4_SetDemuxModel'] = function () {
            return (_JSPlayM4_SetDemuxModel = Module['_JSPlayM4_SetDemuxModel'] = Module['asm']['Tc']).apply(null, arguments);
        });
        var _JSPlayM4_SetD3DPostProcess = (Module['_JSPlayM4_SetD3DPostProcess'] = function () {
            return (_JSPlayM4_SetD3DPostProcess = Module['_JSPlayM4_SetD3DPostProcess'] = Module['asm']['Uc']).apply(null, arguments);
        });
        var _JSPlayM4_SetDecodeEngine = (Module['_JSPlayM4_SetDecodeEngine'] = function () {
            return (_JSPlayM4_SetDecodeEngine = Module['_JSPlayM4_SetDecodeEngine'] = Module['asm']['Vc']).apply(null, arguments);
        });
        var _JSPlayM4_SetGlobalBaseTime = (Module['_JSPlayM4_SetGlobalBaseTime'] = function () {
            return (_JSPlayM4_SetGlobalBaseTime = Module['_JSPlayM4_SetGlobalBaseTime'] = Module['asm']['Wc']).apply(null, arguments);
        });
        var _JSPlayM4_GetPlayedTimeEx = (Module['_JSPlayM4_GetPlayedTimeEx'] = function () {
            return (_JSPlayM4_GetPlayedTimeEx = Module['_JSPlayM4_GetPlayedTimeEx'] = Module['asm']['Xc']).apply(null, arguments);
        });
        var _JSPlayM4_GetFileTime = (Module['_JSPlayM4_GetFileTime'] = function () {
            return (_JSPlayM4_GetFileTime = Module['_JSPlayM4_GetFileTime'] = Module['asm']['Yc']).apply(null, arguments);
        });
        var _JSPlayM4_GetMpOffset = (Module['_JSPlayM4_GetMpOffset'] = function () {
            return (_JSPlayM4_GetMpOffset = Module['_JSPlayM4_GetMpOffset'] = Module['asm']['Zc']).apply(null, arguments);
        });
        var _JSPlayM4_ResetBuffer = (Module['_JSPlayM4_ResetBuffer'] = function () {
            return (_JSPlayM4_ResetBuffer = Module['_JSPlayM4_ResetBuffer'] = Module['asm']['_c']).apply(null, arguments);
        });
        var _JSPlayM4_ResetEnd = (Module['_JSPlayM4_ResetEnd'] = function () {
            return (_JSPlayM4_ResetEnd = Module['_JSPlayM4_ResetEnd'] = Module['asm']['$c']).apply(null, arguments);
        });
        var _JSPlayM4_IgnoreHeaderAudioDefine = (Module['_JSPlayM4_IgnoreHeaderAudioDefine'] = function () {
            return (_JSPlayM4_IgnoreHeaderAudioDefine = Module['_JSPlayM4_IgnoreHeaderAudioDefine'] = Module['asm']['ad']).apply(null, arguments);
        });
        var _JSPlayM4_SetSycGroup = (Module['_JSPlayM4_SetSycGroup'] = function () {
            return (_JSPlayM4_SetSycGroup = Module['_JSPlayM4_SetSycGroup'] = Module['asm']['bd']).apply(null, arguments);
        });
        var _JSPlayM4_GetRawData = (Module['_JSPlayM4_GetRawData'] = function () {
            return (_JSPlayM4_GetRawData = Module['_JSPlayM4_GetRawData'] = Module['asm']['cd']).apply(null, arguments);
        });
        var _JSPlayM4_VideoDataToBMP = (Module['_JSPlayM4_VideoDataToBMP'] = function () {
            return (_JSPlayM4_VideoDataToBMP = Module['_JSPlayM4_VideoDataToBMP'] = Module['asm']['dd']).apply(null, arguments);
        });
        var _JSPlayM4_VideoDataToJpeg = (Module['_JSPlayM4_VideoDataToJpeg'] = function () {
            return (_JSPlayM4_VideoDataToJpeg = Module['_JSPlayM4_VideoDataToJpeg'] = Module['asm']['ed']).apply(null, arguments);
        });
        var _JSPlayM4_SetRunTimeInfoCallBackEx = (Module['_JSPlayM4_SetRunTimeInfoCallBackEx'] = function () {
            return (_JSPlayM4_SetRunTimeInfoCallBackEx = Module['_JSPlayM4_SetRunTimeInfoCallBackEx'] = Module['asm']['fd']).apply(null, arguments);
        });
        var _JSPlayM4_SetPlayOrBackSwitchMode = (Module['_JSPlayM4_SetPlayOrBackSwitchMode'] = function () {
            return (_JSPlayM4_SetPlayOrBackSwitchMode = Module['_JSPlayM4_SetPlayOrBackSwitchMode'] = Module['asm']['gd']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_GetPort = (Module['_JSPlayM4_FEC_GetPort'] = function () {
            return (_JSPlayM4_FEC_GetPort = Module['_JSPlayM4_FEC_GetPort'] = Module['asm']['hd']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_Enable = (Module['_JSPlayM4_FEC_Enable'] = function () {
            return (_JSPlayM4_FEC_Enable = Module['_JSPlayM4_FEC_Enable'] = Module['asm']['id']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_SetParam = (Module['_JSPlayM4_FEC_SetParam'] = function () {
            return (_JSPlayM4_FEC_SetParam = Module['_JSPlayM4_FEC_SetParam'] = Module['asm']['jd']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_SetViewParam = (Module['_JSPlayM4_FEC_SetViewParam'] = function () {
            return (_JSPlayM4_FEC_SetViewParam = Module['_JSPlayM4_FEC_SetViewParam'] = Module['asm']['kd']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_SetWnd = (Module['_JSPlayM4_FEC_SetWnd'] = function () {
            return (_JSPlayM4_FEC_SetWnd = Module['_JSPlayM4_FEC_SetWnd'] = Module['asm']['ld']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_DelPort = (Module['_JSPlayM4_FEC_DelPort'] = function () {
            return (_JSPlayM4_FEC_DelPort = Module['_JSPlayM4_FEC_DelPort'] = Module['asm']['md']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_Disable = (Module['_JSPlayM4_FEC_Disable'] = function () {
            return (_JSPlayM4_FEC_Disable = Module['_JSPlayM4_FEC_Disable'] = Module['asm']['nd']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_ResetCorrectType = (Module['_JSPlayM4_FEC_ResetCorrectType'] = function () {
            return (_JSPlayM4_FEC_ResetCorrectType = Module['_JSPlayM4_FEC_ResetCorrectType'] = Module['asm']['od']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_SetDisplayRegion = (Module['_JSPlayM4_FEC_SetDisplayRegion'] = function () {
            return (_JSPlayM4_FEC_SetDisplayRegion = Module['_JSPlayM4_FEC_SetDisplayRegion'] = Module['asm']['pd']).apply(null, arguments);
        });
        var _JSPlayM4_GetFishEye2DParam = (Module['_JSPlayM4_GetFishEye2DParam'] = function () {
            return (_JSPlayM4_GetFishEye2DParam = Module['_JSPlayM4_GetFishEye2DParam'] = Module['asm']['qd']).apply(null, arguments);
        });
        var _JSPlayM4_GetFishEyeViewParam = (Module['_JSPlayM4_GetFishEyeViewParam'] = function () {
            return (_JSPlayM4_GetFishEyeViewParam = Module['_JSPlayM4_GetFishEyeViewParam'] = Module['asm']['rd']).apply(null, arguments);
        });
        var _JSPlayM4_GetViewParam = (Module['_JSPlayM4_GetViewParam'] = function () {
            return (_JSPlayM4_GetViewParam = Module['_JSPlayM4_GetViewParam'] = Module['asm']['sd']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_SetCanvasID = (Module['_JSPlayM4_FEC_SetCanvasID'] = function () {
            return (_JSPlayM4_FEC_SetCanvasID = Module['_JSPlayM4_FEC_SetCanvasID'] = Module['asm']['td']).apply(null, arguments);
        });
        var _JSPlayM4_FEC_SetBackCilling = (Module['_JSPlayM4_FEC_SetBackCilling'] = function () {
            return (_JSPlayM4_FEC_SetBackCilling = Module['_JSPlayM4_FEC_SetBackCilling'] = Module['asm']['ud']).apply(null, arguments);
        });
        var _emscripten_tls_init = (Module['_emscripten_tls_init'] = function () {
            return (_emscripten_tls_init = Module['_emscripten_tls_init'] = Module['asm']['vd']).apply(null, arguments);
        });
        var ___getTypeName = (Module['___getTypeName'] = function () {
            return (___getTypeName = Module['___getTypeName'] = Module['asm']['xd']).apply(null, arguments);
        });
        var ___embind_register_native_and_builtin_types = (Module['___embind_register_native_and_builtin_types'] = function () {
            return (___embind_register_native_and_builtin_types = Module['___embind_register_native_and_builtin_types'] = Module['asm']['yd']).apply(null, arguments);
        });
        var _emscripten_current_thread_process_queued_calls = (Module['_emscripten_current_thread_process_queued_calls'] = function () {
            return (_emscripten_current_thread_process_queued_calls = Module['_emscripten_current_thread_process_queued_calls'] = Module['asm']['zd']).apply(null, arguments);
        });
        var _emscripten_main_browser_thread_id = (Module['_emscripten_main_browser_thread_id'] = function () {
            return (_emscripten_main_browser_thread_id = Module['_emscripten_main_browser_thread_id'] = Module['asm']['Ad']).apply(null, arguments);
        });
        var _emscripten_sync_run_in_main_thread_4 = (Module['_emscripten_sync_run_in_main_thread_4'] = function () {
            return (_emscripten_sync_run_in_main_thread_4 = Module['_emscripten_sync_run_in_main_thread_4'] = Module['asm']['Bd']).apply(null, arguments);
        });
        var _emscripten_main_thread_process_queued_calls = (Module['_emscripten_main_thread_process_queued_calls'] = function () {
            return (_emscripten_main_thread_process_queued_calls = Module['_emscripten_main_thread_process_queued_calls'] = Module['asm']['Cd']).apply(null, arguments);
        });
        var _emscripten_run_in_main_runtime_thread_js = (Module['_emscripten_run_in_main_runtime_thread_js'] = function () {
            return (_emscripten_run_in_main_runtime_thread_js = Module['_emscripten_run_in_main_runtime_thread_js'] = Module['asm']['Dd']).apply(null, arguments);
        });
        var __emscripten_call_on_thread = (Module['__emscripten_call_on_thread'] = function () {
            return (__emscripten_call_on_thread = Module['__emscripten_call_on_thread'] = Module['asm']['Ed']).apply(null, arguments);
        });
        var __emscripten_thread_exit = (Module['__emscripten_thread_exit'] = function () {
            return (__emscripten_thread_exit = Module['__emscripten_thread_exit'] = Module['asm']['Fd']).apply(null, arguments);
        });
        var _pthread_testcancel = (Module['_pthread_testcancel'] = function () {
            return (_pthread_testcancel = Module['_pthread_testcancel'] = Module['asm']['Gd']).apply(null, arguments);
        });
        var __emscripten_thread_init = (Module['__emscripten_thread_init'] = function () {
            return (__emscripten_thread_init = Module['__emscripten_thread_init'] = Module['asm']['Hd']).apply(null, arguments);
        });
        var _pthread_self = (Module['_pthread_self'] = function () {
            return (_pthread_self = Module['_pthread_self'] = Module['asm']['Id']).apply(null, arguments);
        });
        var _malloc = (Module['_malloc'] = function () {
            return (_malloc = Module['_malloc'] = Module['asm']['Jd']).apply(null, arguments);
        });
        var ___errno_location = (Module['___errno_location'] = function () {
            return (___errno_location = Module['___errno_location'] = Module['asm']['Kd']).apply(null, arguments);
        });
        var __get_tzname = (Module['__get_tzname'] = function () {
            return (__get_tzname = Module['__get_tzname'] = Module['asm']['Ld']).apply(null, arguments);
        });
        var __get_daylight = (Module['__get_daylight'] = function () {
            return (__get_daylight = Module['__get_daylight'] = Module['asm']['Md']).apply(null, arguments);
        });
        var __get_timezone = (Module['__get_timezone'] = function () {
            return (__get_timezone = Module['__get_timezone'] = Module['asm']['Nd']).apply(null, arguments);
        });
        ...
        var _emscripten_stack_set_limits = (Module['_emscripten_stack_set_limits'] = function () {
            return (_emscripten_stack_set_limits = Module['_emscripten_stack_set_limits'] = Module['asm']['Rd']).apply(null, arguments);
        });
        var _setThrew = (Module['_setThrew'] = function () {
            return (_setThrew = Module['_setThrew'] = Module['asm']['Sd']).apply(null, arguments);
        });
        var _free = (Module['_free'] = function () {
            return (_free = Module['_free'] = Module['asm']['Td']).apply(null, arguments);
        });
        var _memalign = (Module['_memalign'] = function () {
            return (_memalign = Module['_memalign'] = Module['asm']['Ud']).apply(null, arguments);
        });
        var __emscripten_allow_main_runtime_queued_calls = (Module['__emscripten_allow_main_runtime_queued_calls'] = 584144);
        var __emscripten_main_thread_futex = (Module['__emscripten_main_thread_futex'] = 604848);
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = JSPlayerModule;
else if (typeof define === 'function' && define['amd'])
    define([], function () {
        return JSPlayerModule;
    });
else if (typeof exports === 'object') exports['JSPlayerModule'] = JSPlayerModule;
